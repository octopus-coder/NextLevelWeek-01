...
import { View, Text, StyleSheet, StatusBar, Image, TouchableOpacity, SafeAreaView, Linking } from 'react-native';
...
const Detail = () => {
  ...
  function handleWhatsApp() {
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=I am interested in residue collection`);
  }
